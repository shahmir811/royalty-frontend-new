<template>
	<div class="navbar-wrapping-div">
		<b-navbar toggleable="lg" type="dark" variant="info" class="navbar-wrapper-class">
			<b-navbar-brand href="#">
				...
				<b-navbar-nav class="ml-auto">
					<b-nav-item-dropdown right v-if="isAuthenticated">
						...
						<template #button-content>
							<em><i class="fa fa-user" aria-hidden="true"></i> Welcome, {{ user.name }}</em>
						</template>
					...
					<b-nav-item href="#" @click.prevent="exitApplication" v-else
						><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</b-nav-item
					>
				</b-navbar-nav>
			</b-collapse>
		</b-navbar>
