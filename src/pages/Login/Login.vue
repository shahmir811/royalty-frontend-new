	...
	<div class="login-page-wrapping-div">
		<div class="login-page-box">
			...
			<b-form @submit.prevent="onSubmit">
				<b-form-group id="input-group-1" label="Email address:" label-for="input-1" class="login-page-email-group-div">
					<b-form-input
						id="input-1"
						v-model="form.email"
						type="text"
				...
				<b-form-group id="input-group-2" label="Password:" label-for="input-2" class="login-page-password-group-div">
					<b-form-input
						id="input-2"
				...
				<router-link to="/forgot-password" class="goto-forgot-password-page"> Forgot password </router-link>

				<b-button type="submit" class="login-page-submit-button" :disabled="loading">
