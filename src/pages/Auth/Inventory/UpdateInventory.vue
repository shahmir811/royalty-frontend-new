		...
		<b-row align-h="center" v-if="form">
			<b-col cols="8">
				<b-form @submit.prevent="submitForm">
					<b-form-group id="input-group-1" label="Item Name:" label-for="input-1" class="input-form-label">
						<b-form-input
							id="input-1"
					...
					<b-form-group id="input-group-2" label="Store Location:" label-for="input-2" class="input-form-label">
						<b-form-input
							id="input-2"
					...
					<b-form-group id="input-group-2" label="Quantity:" label-for="input-2" class="input-form-label">
						<b-form-input
							id="input-2"
					...
					<b-form-group id="input-group-5" label="Purchase price:" label-for="input-5" class="input-form-label">
						<b-form-input
							id="input-5"
						...
						></b-form-input>
						<span class="invalid-feedback left-text" v-if="errors.purchase_price">
							<strong>{{ errors.purchase_price[0] }}</strong>
						</span>
					</b-form-group>

					<b-form-group id="input-group-6" label="Sale price:" label-for="input-6" class="input-form-label">
						<b-form-input
							id="input-6"
						...
						<span v-if="lowSalePrice" class="red-text"> Sale price is lower than purchase price </span>
					</b-form-group>

					<b-form-group id="input-group-7" label="Average price:" label-for="input-7" class="input-form-label">
						<b-form-input
							id="input-7"
					...
					<div class="add-user-btn-group">
						...
						<router-link to="/inventory" class="btn btn-danger admin-add-user-cancel-button"
...
export default {
	...
	methods: {
		...
		removeCommas() {
			this.form.purchase_price = this.formatDigits(this.form.purchase_price);
			this.form.sale_price = this.formatDigits(this.form.sale_price);
			this.form.avg_price = this.formatDigits(this.form.avg_price);
		},
		formatDigits(digit) {
