			...
			<b-col cols="8">
				<b-form @submit.prevent="submitForm">
					<div class="form-group input-form-label text-left">
						...
						<v-select :options="items" :reduce="name => name.id" v-model="form.item_id" label="name" />
					...
					<b-form-group id="input-group-8" label="Quantity:" label-for="input-8" class="input-form-label">
						<b-form-input
							id="input-8"
...
export default {
	...
	computed: {
		...
		lowSalePrice() {
			const condition = parseInt(this.form.sale_price) < parseInt(this.form.purchase_price);
